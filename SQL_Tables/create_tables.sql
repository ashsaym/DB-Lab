-- Datenbanken Praktikum WS 2021/2022
-- Musterlösung - Create Table-Statements
-- Schritt 1) Erzeugung der Datenbank: db2 "create database sharer"
-- Schritt 2) Verbindung zur Datenbank herstellen: db2 "connect to sharer"
